...
void CPreferences::LoadParaFile(UINT item)
{
	...
	if (ReadFile())
	{
		...
		{
			portnum = GetValueI(L"projectSetting", L"PORTNUM");
			parity = GetValueStr(L"projectSetting", L"PARITY");
			stopbits = GetValueStr(L"projectSetting", L"STOPBITS");
			baud = GetValueI(L"projectSetting", L"BAUD");
			databits = GetValueI(L"projectSetting", L"DATABITS");
			TimeLimit = GetValueI(L"projectSetting", L"TIMELIMIT");
			m_row = GetValueI(L"projectSetting", L"ROW");
			m_col = GetValueI(L"projectSetting", L"COL");
			model_path = GetValueStr(L"projectSetting", L"MODEL_PATH");

			portnum1 = GetValueI(L"projectSetting", L"PORTNUM1");
			parity1 = GetValueStr(L"projectSetting", L"PARITY1");
			stopbits1 = GetValueStr(L"projectSetting", L"STOPBITS1");
			baud1 = GetValueI(L"projectSetting", L"BAUD1");
			databits1 = GetValueI(L"projectSetting", L"DATABITS1");
			TimeLimit1 = GetValueI(L"projectSetting", L"TIMELIMIT1");
			m_row1 = GetValueI(L"projectSetting", L"ROW1");
			m_col1 = GetValueI(L"projectSetting", L"COL1");
			model_path1 = GetValueStr(L"projectSetting", L"MODEL_PATH1");

			m_Motor1Wise = GetValueI(L"projectSetting", L"MOTORWISE");
			m_Motor1Speed = GetValueI(L"projectSetting", L"MOTORSPPED");
			m_Motor1BackSpeed = GetValueI(L"projectSetting", L"MOTORBACKSPPED");
			m_Motor1Acc = GetValueF(L"projectSetting", L"MOTORACC");
			m_Motor1Compensate = GetValueI(L"projectSetting", L"MOTORCOMPENSATE");
			m_Motor1Step = GetValueI(L"projectSetting", L"MOTORSTEP");
			m_Motor1StepByContol = GetValueI(L"projectSetting", L"MOTORSETPCTRL");;//手动控制用的步进

			m_value_threshold = GetValueF(L"projectSetting", L"THRESHOLD_VALUE");
			
		}
		if (PARA_IMAGE == (mask&PARA_IMAGE))
		{
			CompareValue1 = GetValueStr(L"image", L"COMPARAVALUE1");
			CompareValue2 = GetValueStr(L"image", L"COMPARAVALUE2");
			CompareValue3 = GetValueStr(L"image", L"COMPARAVALUE3");
			CompareValue4 = GetValueStr(L"image", L"COMPARAVALUE4");
			adjustValue1 = GetValueStr(L"image", L"ADJUSTVALUE1");
		}
...
void CPreferences::SaveParaFile(UINT item)
{
	...
	if (PARA_PRJ==(mask&PARA_PRJ))
	{
		...
		SetValueI(L"projectSetting", L"PORTNUM", portnum);
		SetValueStr(L"projectSetting", L"PARITY", parity);
		SetValueStr(L"projectSetting", L"STOPBITS", stopbits);
		SetValueI(L"projectSetting", L"BAUD", baud);
		SetValueI(L"projectSetting", L"DATABITS", databits);
		SetValueI(L"projectSetting", L"TIMELIMIT",TimeLimit);
		SetValueI(L"projectSetting", L"ROW", m_row);
		SetValueI(L"projectSetting", L"COL", m_col);
		SetValueStr(L"projectSetting", L"MODEL_PATH",model_path);
		
		SetValueI(L"projectSetting", L"PORTNUM1", portnum1);
		SetValueStr(L"projectSetting", L"PARITY1", parity1);
		SetValueStr(L"projectSetting", L"STOPBITS1", stopbits1);
		SetValueI(L"projectSetting", L"BAUD1", baud1);
		SetValueI(L"projectSetting", L"DATABITS1", databits1);
		SetValueI(L"projectSetting", L"TIMELIMIT1", TimeLimit1);
		SetValueI(L"projectSetting", L"ROW1", m_row1);
		SetValueI(L"projectSetting", L"COL1", m_col1);
		SetValueStr(L"projectSetting", L"MODEL_PATH1", model_path1);

		SetValueI(L"projectSetting", L"MOTORWISE", m_Motor1Wise);
		SetValueI(L"projectSetting", L"MOTORSPPED", m_Motor1Speed);
		SetValueI(L"projectSetting", L"MOTORBACKSPPED", m_Motor1BackSpeed);
		SetValueF(L"projectSetting", L"MOTORACC", m_Motor1Acc);
		SetValueI(L"projectSetting", L"MOTORCOMPENSATE", m_Motor1Compensate);
		SetValueI(L"projectSetting", L"MOTORSTEP", m_Motor1Step);
		SetValueI(L"projectSetting", L"MOTORSETPCTRL", m_Motor1StepByContol);//手动控制用的步进

		SetValueF(L"projectSetting", L"THRESHOLD_VALUE", m_value_threshold);

	}

	if(PARA_IMAGE==(mask&PARA_IMAGE))
	{
		SetValueStr(L"image", L"COMPARAVALUE1", CompareValue1);
		SetValueStr(L"image", L"COMPARAVALUE2", CompareValue2);
		SetValueStr(L"image", L"COMPARAVALUE3", CompareValue3);
		SetValueStr(L"image", L"COMPARAVALUE4", CompareValue4);

		SetValueStr(L"image", L"ADJUSTVALUE1", adjustValue1);
